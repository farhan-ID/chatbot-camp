...
def get_answer(prompt, history, file=False):
    fix_prompt = f"""You are helpful assistant, your name is 'Cele'. Your task is answer the question from user. If user asking about your capabilities, you can answer with this capabilities:
    - You can answer question based on your default knowledge.
    - You can do brainstorming with user.
User: {prompt}
...
def get_answer_web(prompt, history):
    ...
    - You can answer question based on your default knowledge.
    - You can do brainstorming with user.
    - You can search on internet to get real-time information and answer question based on that.
User: {prompt}
...
background_image_path = "./bg.jpeg"  # Relative path to the image
